...
echo "📊 Expected Tools Count: 38"
echo ""
echo "🔍 Tool Categories:"
echo "   • Legacy single-cluster tools: 8"
echo "   • Multi-cluster management tools: 10" 
echo "   • Snapshot policy management: 7"
echo "   • Export policy management: 9"
echo "   • Volume configuration/update: 4"
echo ""

echo "📋 Complete Tool List:"
echo ""
...
echo " 35. get_volume_configuration"
echo " 36. update_volume_security_style"
echo " 37. resize_volume"
echo " 38. update_volume_comment"
echo ""

echo "✅ Fixed Issues:"
echo "   • Removed duplicate 'apply_snapshot_policy_to_volume' from volume-update-tools"
echo "   • Removed duplicate 'remove_snapshot_policy_from_volume' from volume-update-tools"
echo "   • Updated tool registrations in index.ts"
echo "   • Cleaned up duplicate imports"
echo ""

echo "🎯 Result: VS Code should now show all 38 tools in the MCP tools dropdown"
echo ""

echo "📝 To verify:"
echo "   1. Restart VS Code"
echo "   2. Go to MCP tools dropdown for 'netapp-ontap-mcp'"
echo "   3. Check that 38 tools are listed (not just 4)"
